...
<footer
        ...
        <div class="wp-block-column">
            ...
            <div class="wp-block-columns">
                ...
                <div class="wp-block-column">
                    ...
                    <!-- wp:navigation {"customTextColor":"#e0e0e0","style":{"typography":{"fontStyle":"normal","fontWeight":"400"}},"fontSize":"medium","fontFamily":"inter","layout":{"type":"flex","orientation":"vertical"}}  -->
                ...
                <div class="wp-block-column">
                    ...
                    <!-- wp:navigation {"style":{"typography":{"fontStyle":"normal","fontWeight":"400"}},"fontSize":"medium","fontFamily":"inter","layout":{"type":"flex","orientation":"vertical"}} -->
    ...
    <div class="wp-block-group alignwide"
        ...
        <!-- wp:navigation {"ref":4,"style":{"typography":{"fontStyle":"normal","fontWeight":"400"}},"fontSize":"medium","fontFamily":"inter","layout":{"type":"flex","orientation":"horizontal"}} /-->
    </div>
    <!-- /wp:group -->
</footer>
<!-- /wp:group -->