 ...
 * Slug: nivaro/template-archive
 * Template Types: archive, category, tag, author, date
 * Viewport width: 1400
 * Inserter: no
 */
?>
<!-- wp:group {"tagName":"main","metadata":{"categories":["nivaro/page"],"patternName":"nivaro/page-services","name":"Archive"},"align":"full","style":{"spacing":{"blockGap":"var:preset|spacing|40"}},"layout":{"type":"constrained"}} -->
<main class="wp-block-group alignfull">
    ...
    <div class="wp-block-group alignfull"
        ...
        <div class="wp-block-columns alignwide" style="padding-top:0">
            ...
            <div class="wp-block-column" style="flex-basis:70%">
                ...
                <!-- wp:term-description {"textAlign":"center","style":{"elements":{"link":{"color":{"text":"var:preset|color|content-secondary"}}}},"textColor":"content-secondary"} /-->
            </div>
            <!-- /wp:column -->
    ...
    <section class="wp-block-group alignfull"
        style="padding-top:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--30)">
        <!-- wp:query {"queryId":14,"query":{"perPage":10,"pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":true},"align":"wide"} -->
        <div class="wp-block-query alignwide">
            ...
            <div class="wp-block-group">
                <!-- wp:query-pagination {"paginationArrow":"arrow","align":"center","style":{"elements":{"link":{"color":{"text":"#575757"}}},"color":{"text":"#575757"}},"layout":{"type":"flex","justifyContent":"center"}} -->
